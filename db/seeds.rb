...
blog1 = admin_user1.posts.create(
    title: 'Day in the life of MK',
...
blog2 = admin_user1.posts.create(
...
blog3 = admin_user1.posts.create(
    title: 'Thoughts on this subject',
...
blog4 = admin_user1.posts.create(
    title: 'Makeup stories',
...
blog5 = admin_user1.posts.create(
...
comment2 = blog2.comments.new(body: "I have to disagree with some points here, but lovely writing!")
comment2.user = member_user2
comment2.save!

comment3 = blog3.comments.new(body: "Wow you totall changed my mind on the subject!")
comment3.user = member_user3
comment3.save!

comment4 = blog4.comments.new(body: "Hey I'd like to talk to you about some points you made. I will send you an email!")
comment4.user = member_user4
comment4.save!
